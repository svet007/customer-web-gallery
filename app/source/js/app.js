...
$( document ).ready(function() {
    ...
    var settings = {
        ...
        body_slide: 0, //set it to true if you want to use the effect where the entire page slides and not just the div
        no_scroll: 0, //set to true if you want the scrolling disabled while the menu is active
    };
